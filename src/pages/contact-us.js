          ...
          <div className="space-y-6 text-gray-800">
            ...
            <div className="bg-white rounded-xl shadow-md p-6 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  Aurora Water Front, SaltLake Sector-V,<br />
                  Kolkata, India
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700">+91 7903439563, +91 6299780200</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  <a href="mailto:info@careerops.in" className="underline hover:text-blue-600">info@careerops.in</a>
                </p>
              </div>
            </div>
          </div>
